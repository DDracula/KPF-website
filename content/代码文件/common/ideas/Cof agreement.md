...
ideas = {
    hidden_ideas = {
		...
		Cof_ard1_nationalization = {
			modifier = { 
				political_power_factor = 0.1
				army_org_factor = -0.1 
				monthly_change_aauto = 0.3
			}
		}
		Cof_ard1_politicization = {
			modifier = {
				political_power_factor = -0.1
				army_org_factor = 0.1
				monthly_change_aauto = -0.3
		...
		Cof_ard2_unbiased = {
			modifier = {
				...
				monthly_change_awill = -0.1
			}
		}
		Cof_ard2_centralization = {
			modifier = {
				max_planning = 0.1
		...
		Cof_ard4_unbiased = {
			modifier = {
				...
				monthly_change_aequip = -0.1
			}
		}
		Cof_ard4_srmorization = {
			modifier = {
				army_armor_defence_factor = 0.1
				supply_consumption_factor = 0.1
				monthly_change_aequip = 0.3
			}
		}
		Cof_ard4_lightweighting = {
			modifier = {
				army_armor_defence_factor = -0.1
				supply_consumption_factor = -0.1
				monthly_change_aequip = -0.3
		...
		Cof_ard5_motorization = {
			modifier = {
				army_speed_factor = 0.1
				max_dig_in_factor = -0.1
			}
		}
		Cof_ard5_positionization = {
			modifier = {
				army_speed_factor = -0.1
				max_dig_in_factor = 0.1
			}
		...
		#8
		Cof_decentralized_chain_of_command = {
			modifier = {
				political_power_factor = -0.2
		...
		Cof_take_over_command2 = {
			name = Cof_take_over_command
			modifier = {
				command_power_gain = 0.5
		...
		#11
		Cof_operating_table_war_diagnose = {
			modifier = {
				custom_modifier_tooltip = Cof_operating_table_war_tt
				planning_speed = 0.25
				max_planning = 0.15
				max_planning_factor = 0.1
		...
		Cof_operating_table_war_operate = {
			modifier = {
				custom_modifier_tooltip = Cof_operating_table_war_tt
				planning_speed = -0.75
				max_planning = -0.3
		...
		Cof_world_army = { 
			modifier = {
				custom_modifier_tooltip = Cof_world_army_tt
				stability_factor = -0.2
				political_power_cost = 0.25
				conscription_factor = 0.2
				weekly_manpower = 2000
				monthly_change_atrain = -0.6
			}
		}
		#13
		Cof_cultivating_comradeship = {
			modifier = {
				experience_gain_army_factor = -0.15
		...
		#14
		Cof_armor_research_funding = {
			modifier = {
				economy_power_factor = -20
				monthly_change_aequip = 0.3
			}
			research_bonus = {
                armor = 0.33
		...
		Cof_dominant_firepower_left = {
			name = Cof_dominant_firepower
			modifier = {
				max_dig_in_factor = 0.1
		...
		#20
		Cof_travel_thousand_miles_a_day = {
			modifier = {
				army_speed_factor = 0.1
		...
		#22
		Cof_appraisal_advancement = {
			modifier = {
				war_support_factor = -0.15
				political_power_factor = 0.1
				experience_gain_army_factor = 0.15
				army_org_factor = 0.05
				monthly_change_atrain = 0.5
			}
		}
		...
		bill_freedom_of_religion_amendment = {
			modifier = {
				political_power_factor = 0.05
				drift_defence_factor = -0.15
				consumer_goods_factor = -0.05

				monthly_change_popsp = 0.6
			}
		}
		#5
	...
	mobilization_laws = {
		...
		construction_corps = {
			...
			allowed = { 
				tag = FRA 
				has_completed_focus = FRA_construction_corps
			}
